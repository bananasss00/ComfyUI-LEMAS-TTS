...
# Support explicit override via env var (for ComfyUI integration)
_env_root = os.environ.get("LEMAS_PRETRAINED_ROOT")
if _env_root and Path(_env_root).is_dir():
    PRETRAINED_ROOT = Path(_env_root)
    REPO_ROOT = PRETRAINED_ROOT.parent
else:
